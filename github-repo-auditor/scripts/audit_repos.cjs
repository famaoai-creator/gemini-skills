...
function audit() {
  ...
  try {
    ...
    repos.forEach(repo => {
      ...
      } else if (name.includes('idp-') || name.includes('authnz') || name.includes('keycloak') || name.includes('strongauth')) {
        mapping['IDP / Auth Infrastructure'].push(repo);
      } else if (name.includes('remit-') || name.includes('wallet-') || name.includes('ripple-') || name.includes('token-')) {
        mapping['Remit / Wallet / Crypto'].push(repo);
      } else if (name.includes('fc-') || name.includes('sre-') || name.includes('terraform-') || name.includes('ansible-') || name.includes('infops-')) {
