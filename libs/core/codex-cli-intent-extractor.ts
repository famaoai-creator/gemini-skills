...
export interface CodexCliIntentExtractorOptions extends CodexCliQueryOptions {}

export class CodexCliIntentExtractor implements IntentExtractor {
  readonly name = 'codex-cli';
  private readonly options: CodexCliQueryOptions;

  constructor(options: CodexCliIntentExtractorOptions = {}) {
  ...
  async extract(input: ExtractIntentInput): Promise<IntentBody> {
    ...
    const parsed = (await runCodexCliQuery({
