...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  // Additional themes for multi-master presentations
  for (let i = 2; i <= masterCount; i++) {
    xml += `\n  <Override PartName="/ppt/theme/theme${i}.xml" ContentType="application/vnd.openxmlformats-officedocument.theme+xml"/>`;
  }
