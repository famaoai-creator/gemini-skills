...
describe('knowledge-refiner lib', () => {
  ...
  it('should detect similar duplicates', () => {
    const longContent1 = 'this is a long enough content to test similarity between two files. it needs more than twenty words to trigger the similarity detection logic in the refiner engine.';
    const longContent2 = 'this IS a long enough content to test similarity between two FILES. it needs more than twenty words to trigger the similarity detection logic in the refiner engine.';
