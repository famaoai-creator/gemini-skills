...
describe('audio-transcriber lib', () => {
  ...
  it('should throw error if file does not exist', async () => {
    ...
    await expect(transcribeAudio('/missing.mp3', { apiKey: 'test' }))
  ...
  it('should throw error if file is too large', async () => {
    ...
    await expect(transcribeAudio('/large.mp3', { apiKey: 'test' }))
  ...
  it('should handle API errors correctly', async () => {
    ...
    await expect(transcribeAudio('/test.mp3', { apiKey: 'bad-key' }))
