/**
 * Type definitions for the token-economist skill.
 *
 * The token-economist analyzes text or code content and produces token count
...
/** CLI arguments accepted by the token-economist skill. */
...
/** Detected content type used to select the token-estimation ratio. */
...
/** Full result data returned by the token-economist skill. */
...
/** Standard skill-wrapper envelope typed for the token-economist result. */
