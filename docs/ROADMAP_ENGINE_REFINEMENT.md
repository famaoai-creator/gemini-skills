...
- [x] **6.4** Mission 作成時にプロジェクト/track スコープを named option で指定可能にする — `pnpm mission start TASK-01 --tier confidential --project-id canton-node --project-path active/projects/canton-node --track-id TRK-REL1`
