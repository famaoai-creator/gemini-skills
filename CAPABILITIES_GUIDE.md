...
| `browser-actuator` | Pipeline-driven Playwright browser execution and session artifact actuator | 1.0.0 | 1 | `schemas/browser-pipeline.schema.json` | `libs/actuators/browser-actuator` |
...
| `presence-actuator` | Human Presence and Messaging Bridge | 1.0.0 | 2 | `schemas/presence-action.schema.json` | `libs/actuators/presence-actuator` |
...
| `system-actuator` | OS-level control, diagnostics, and short-lived local execution | 1.0.0 | 2 | `schemas/system-pipeline.schema.json` | `libs/actuators/system-actuator` |
| `terminal-actuator` | PTY-driven Terminal Actuator | 1.0.0 | 4 | `schemas/terminal-action.schema.json` | `libs/actuators/terminal-actuator` |
