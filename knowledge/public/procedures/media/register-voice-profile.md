...
- **Schemas**:
  - [`voice-sample-collection.schema.json`](knowledge/public/schemas/voice-sample-collection.schema.json)
  - [`voice-profile-registration.schema.json`](knowledge/public/schemas/voice-profile-registration.schema.json)
  - [`voice-sample-ingestion-policy.schema.json`](knowledge/public/schemas/voice-sample-ingestion-policy.schema.json)
- **Governance**:
  - [`voice-sample-ingestion-policy.json`](knowledge/public/governance/voice-sample-ingestion-policy.json)
...
- [collect-voice-samples.md](knowledge/public/procedures/media/collect-voice-samples.md)
...
- [promote-voice-profile.md](knowledge/public/procedures/media/promote-voice-profile.md)
