...
- **Schemas**:
  - [`narrated-video-brief.schema.json`](knowledge/public/schemas/narrated-video-brief.schema.json)
  - [`video-composition-action.schema.json`](schemas/video-composition-action.schema.json)
- **Procedure**:
  - [`compose-video-from-adf.md`](knowledge/public/procedures/media/compose-video-from-adf.md)
