...
- [media-document-generation-boundary.md](knowledge/public/architecture/media-document-generation-boundary.md)

The preset catalog is stored as directory-scanned knowledge packs at:

- [media-design-systems](knowledge/public/design-patterns/media-templates/media-design-systems/defaults.json)
- [document-composition-presets](knowledge/public/design-patterns/media-templates/document-composition-presets/defaults.json)
- [slide-layout-presets](knowledge/public/design-patterns/media-templates/slide-layout-presets/defaults.json)
- [semantic-render-tokens](knowledge/public/design-patterns/media-templates/semantic-render-tokens/defaults.json)
- [artifact-library](knowledge/public/design-patterns/media-templates/artifact-library/project-mgmt-high-fidelity.json)
- [design-md-catalog](knowledge/public/design-patterns/media-templates/design-md-catalog/README.md)
