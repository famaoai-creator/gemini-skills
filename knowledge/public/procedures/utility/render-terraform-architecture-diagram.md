...
## 6. Example Artifacts
- [`terraform-to-architecture-adf.json`](/Users/famaoai/k/a/kyberion/libs/actuators/modeling-actuator/examples/terraform-to-architecture-adf.json)
- [`terraform-architecture-adf-to-drawio.json`](/Users/famaoai/k/a/kyberion/libs/actuators/media-actuator/examples/terraform-architecture-adf-to-drawio.json)
