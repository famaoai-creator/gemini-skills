...
Use [`knowledge/public/governance/active-surfaces.json`](knowledge/public/governance/active-surfaces.json) as the declaration source, then reconcile with:
...
- [`generation-schedule-surface.json`](knowledge/public/governance/pipelines/generation-schedule-surface.json)
