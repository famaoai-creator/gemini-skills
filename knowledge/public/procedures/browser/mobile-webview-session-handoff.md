...
- handoff artifact schema:
  [`webview-session-handoff.schema.json`](knowledge/public/schemas/webview-session-handoff.schema.json)
- mobile profile schema:
  [`mobile-app-profile.schema.json`](knowledge/public/schemas/mobile-app-profile.schema.json)
- shared mobile profiles:
  [`mobile-app-profiles/index.json`](knowledge/public/orchestration/mobile-app-profiles/index.json)
...
- shared stubs:
  [`README.md`](knowledge/public/templates/mobile-webview-handoff/README.md)
