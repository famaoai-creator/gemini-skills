...
- [`web-app-profile.schema.json`](knowledge/public/schemas/web-app-profile.schema.json)
- [`example-web-login-guarded.json`](knowledge/public/orchestration/web-app-profiles/example-web-login-guarded.json)

## Shared Templates

- [`web-sample-apps/README.md`](knowledge/public/templates/web-sample-apps/README.md)
...
- UI flow schema:
  [`ui-flow-adf.schema.json`](knowledge/public/schemas/ui-flow-adf.schema.json)
- test inventory schema:
  [`test-case-adf.schema.json`](knowledge/public/schemas/test-case-adf.schema.json)
