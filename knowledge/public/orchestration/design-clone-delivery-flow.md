...
- [`design-clone-and-build-web.md`](knowledge/public/procedures/service/design-clone-and-build-web.md)

Mobile:

- [`design-clone-and-build-mobile.md`](knowledge/public/procedures/service/design-clone-and-build-mobile.md)

Deliverables:

- [`deliver-design-spec-and-test-pack.md`](knowledge/public/procedures/service/deliver-design-spec-and-test-pack.md)

Intake:

- [`design-clone-request-intake.md`](knowledge/public/templates/blueprints/design-clone-request-intake.md)
