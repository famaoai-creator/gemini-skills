...
- [intent-outcome-patterns.md](knowledge/public/architecture/intent-outcome-patterns.md)
- [intent-outcome-patterns.json](knowledge/public/governance/intent-outcome-patterns.json)
...
The catalog in [standard-intents.json](knowledge/public/governance/standard-intents.json) is now much closer to the runtime entry points.
...
[work-design.ts](libs/core/work-design.ts) can reason about outcomes that should always be declared in [outcome-catalog.json](knowledge/public/governance/outcome-catalog.json).
