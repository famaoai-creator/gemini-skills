...
- [knowledge/public/orchestration/](../orchestration/) — プロトコル群
- [knowledge/public/architecture/cli-harness-coordination-model.md](./cli-harness-coordination-model.md) — 可換層の責務分割
- [knowledge/public/architecture/hardening-backlog.md](./hardening-backlog.md) — 細部担保計画
