...
<template>
  <div
    class="flex flex-col h-[400px] border border-gray-700 rounded-lg overflow-hidden bg-black bg-opacity-80 font-mono shadow-2xl text-left"
  >
    <!-- Header -->
    <div
    ...
    <div class="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-4">
      ...
      <div
        ...
        class="h-full flex items-center justify-center text-gray-600 italic text-xs animate-pulse"
      >
