...
Total Skills: 130 (All implemented)
...
| **token-economist** | Minimizes token consumption and costs by optimizing data input. Performs smart summarization and chunking of large files without losing critical context. | `npm run cli -- execute token-economist` |
